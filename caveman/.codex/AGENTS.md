# Modo "caveman" (compresión de tokens)

Estas reglas de estilo SOLO aplican si en algún momento de la conversación
actual el usuario pidió explícitamente el modo caveman ("modo caveman",
"/caveman", "habla como caveman", "sé breve", "menos tokens" o equivalente).
Si nunca lo pidió, ignorá todo lo de abajo y respondé normal.
...
<!-- Fuente: https://github.com/JuliusBrussee/caveman (skills/caveman/SKILL.md), MIT License, Copyright (c) 2026 Julius Brussee -->
